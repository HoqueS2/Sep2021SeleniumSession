...
public class AnnotationsConcept {
	...
	/**
	 * BS -- DBConnection BT -- createUser BC -- launchBrowser
	 * 
	 * BM -- loginToApp accountInfoTest AM -- logout
	 * 
	 * BM -- loginToApp userInfoTest AM -- logout
	 * 
	 * AC -- closeBrowser AT -- deleteUser AS -- disconnectDB
	 */
